...
# Υπολογισμός χρόνου εκτέλεσης
end_time1 = time.time()
execution_time1 = end_time1 - end_time
...
print(f"\nΧρόνος Απεικόνισης του γράφου: {execution_time:.20f} δευτερόλεπτα")
print(f"\nΧρόνος DFS: {execution_time1:.20f} δευτερόλεπτα")
print(f"\nΧρόνος BFS: {execution_time2:.20f} δευτερόλεπτα")
print(f"\nΧρόνος Dijkstra: {execution_time3:.20f} δευτερόλεπτα")
print(f"\nΧρόνος Kruskal: {execution_time4:.20f} δευτερόλεπτα")
print(f"\nΧρόνος Prim: {execution_time5:.20f} δευτερόλεπτα")

# Υπολογισμός και εμφάνιση χρόνου εκτέλεσης
end_time = time.time()
execution_time = end_time - start_time
print(f"\nΣυνολικός χρόνος εκτέλεσης: {execution_time:.20f} δευτερόλεπτα")